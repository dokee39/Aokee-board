...
void COMP4_IRQHandler(void)						__attribute__((weak, alias("Undefined_Handler")));
...
FunctionPointer vectorsRom[] =
{
	...
	Undefined_Handler,						//  68
	Undefined_Handler,						//  69
	Undefined_Handler,						//  70
	Undefined_Handler,						//  71
	Undefined_Handler,						//  72
	Undefined_Handler,						//  73
	...
	Undefined_Handler,						//  84
	Undefined_Handler,						//  85
	Undefined_Handler,						//  86
	Undefined_Handler,						//  87
	...
	Undefined_Handler,						//  95
	Undefined_Handler,						//  96
