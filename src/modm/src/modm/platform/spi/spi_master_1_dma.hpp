...
#define MODM_STM32_SPI_MASTER1_DMA_HPP
 ...
 * parameters the class can be used in the same way like the SpiMaster1.
 *
...
#include "spi_master_1_dma_impl.hpp"

#endif // MODM_STM32_SPI_MASTER1_DMA_HPP